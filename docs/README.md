...
This directory contains the foundational specifications for the InvestAnalytics platform.
...
No ADRs recorded yet. ADRs will be added as architectural decisions are made during implementation.
